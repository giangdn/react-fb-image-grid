...
var Images = (_temp = _class = function (_Component) {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.renderVideoOverlay(images[0]),
            overlay
          )
        )
      )
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.renderVideoOverlay(conditionalRender ? images[1] : images[0]),
            this.renderOverlay()
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.renderVideoOverlay(conditionalRender ? images[2] : images[1]),
            overlay
          )
        )
      )
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.renderVideoOverlay(conditionalRender ? images[1] : images[2]),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.renderVideoOverlay(conditionalRender ? images[2] : images[3]),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.renderVideoOverlay(conditionalRender ? images[3] : images[4]),
            overlay
          )
        )
      )
  ...
  Images.prototype.renderVideoOverlay = function renderVideoOverlay(image) {
    var renderVideoOverlay = this.props.renderVideoOverlay;

    return typeof renderVideoOverlay !== "undefined" && typeof image.IsVideo !== "undefined" && parseInt(image.IsVideo) === 1 ? renderVideoOverlay() : "";
  };
...
Images.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  renderVideoOverlay: _propTypes2.default.func,
